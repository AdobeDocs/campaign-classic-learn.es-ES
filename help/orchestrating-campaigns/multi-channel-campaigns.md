...
En una campaña multicanal, una sola comunicación de marketing utiliza varios canales para llegar a un público objetivo más amplio. Los canales se utilizan de forma independiente, sin conexión entre ellos, lo que significa que los clientes permanecen en un canal dentro de un flujo de trabajo.
...
>[!VIDEO](https://video.tv.adobe.com/v/37541?quality=12&learn=on&captions=spa){transcript=true}
